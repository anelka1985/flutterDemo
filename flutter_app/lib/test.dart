...
class customStatelessWidget extends StatelessWidget {
  ...
  customStatelessWidget(this.title);
...
class _DemoStateWidgetState extends State<customStatefulWidget> {
  String text;
...
class customStatefulWidget extends StatefulWidget {
  ...
  customStatefulWidget(this.title);

  @override
  State<StatefulWidget> createState() {
    return new _DemoStateWidgetState(title);
  }
}
...
//void main() {
//  runApp(new customWidget('11111111'));
//}
